...
export const siteConfig: SiteConfig = {
  ...
  alternateNames: ["GGSoftware", "GG Software CZ", "ggsoftware.cz", "ggsoftware"],
  ...
  team: [
    {name: "Jan Novák", role: "Full-stack Developer", photo: ""},
    {name: "Petra Kovářová", role: "Frontend & UX", photo: ""}
  ],
